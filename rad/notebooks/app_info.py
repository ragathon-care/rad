...
try:
    ...
    storage_context = StorageContext.from_defaults(persist_dir="./storage_actual_info")
    # load index
    ...
    reader = SimpleDirectoryReader(input_dir="./final_artifacts/all_informational/")
    data = reader.load_data()
    index = VectorStoreIndex.from_documents(data, service_context=service_context)
    index.storage_context.persist(persist_dir="./storage_actual_info")
