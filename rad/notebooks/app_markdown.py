...
try:
    ...
    storage_context = StorageContext.from_defaults(persist_dir="./storage_info")
    # load index
    ...
    reader = SimpleDirectoryReader(input_dir="./final_artifacts/markdown_files/")
    data = reader.load_data()
    index = VectorStoreIndex.from_documents(data, service_context=service_context)
    index.storage_context.persist(persist_dir="./storage_info")
